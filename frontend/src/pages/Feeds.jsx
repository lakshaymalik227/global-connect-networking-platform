        ...
        <div>
          <Card padding={1}>
            <div className='flex gap-2 items-center'>
              ...
              <div onClick={() => setAddPostModal(true)} className='w-full border-1 py-3 px-3 rounded-3xl xurosr-pointer hover:bg-gray-100'>Start a post</div>
            </div>

            <div className='w-full flex mt-5'>
              <div onClcik={() => setAddPostModal(true)} className='flex gap-2 p-2 cursor-pointer justify-center rounded-lg w-[33%] hover:bg-gray-100'><VideoCallIcon sx={{ color: "green" }} />Vedio</div>
